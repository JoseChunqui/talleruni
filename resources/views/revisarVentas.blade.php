						      ...
						      <!--Botonera de procesar pedido-->
								<div>
									<div class="panel panel-default">
								      ...
								      <div class="panel-body">
								      	<button type="button" class="btn btn-default btn-lg btn-block">Procesar Pedido</button>
										<button type="button" class="btn btn-default btn-lg btn-block">Rechazar Pedido</button>
								      </div>
								    </div>				
								</div>
